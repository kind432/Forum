...
module.exports = function(XRegExp) {
     ...
     * available to provide data for Unicode Forum, scripts, blocks, and properties.
     *
     * @requires XRegExp
     */
...
module.exports = function(XRegExp) {
    ...
    /**
     * Adds support for Unicode's general Forum. E.g., `\p{Lu}` or `\p{Uppercase Letter}`. See
...
module.exports = function(XRegExp) {
     ...
     * #18 RL1.2 additionally requires support for Unicode scripts and general Forum. These are
...
require('./addons/unicode-Forum')(XRegExp);
